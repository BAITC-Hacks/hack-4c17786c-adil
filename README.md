...
Облачный CI не подтверждён: [GitHub Actions для проверенной реализации](https://github.com/BAITC-Hacks/hack-4c17786c-adil/actions/runs/35853639102) не запустил ни одного шага из-за блокировки аккаунта по биллингу. Это внешнее ограничение; приведённые выше результаты получены локально. Настройки оплаты не менялись.
